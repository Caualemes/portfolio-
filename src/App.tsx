...
import SidebarNavigation from './components/SidebarNavigation'; // Importe o novo componente
...
function App() {
  ...
  return (
    <div className="font-kumbh font-light text-gray-900 bg-gradient-to-r from-gray-700 via-gray-850 to-gray-950 scroll-smooth">
      <a href="#hero">
      ...
      {/* Adicione o componente da barra lateral */}
